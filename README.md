# Serious Sam Android [![Build status](https://ci.appveyor.com/api/projects/status/pycufpcyo9i4axl8?svg=true)](https://ci.appveyor.com/project/sergioroprado/serious-sam-android/branch/master)
